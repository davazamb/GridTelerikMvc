...
namespace GridTelerikMvc.WEB.Controllers
{
    public class InvoiceController : Controller
    {
        ...
        public ActionResult Invoices_Read([DataSourceRequest]DataSourceRequest request, string salesPerson, DateTime statsFrom, DateTime statsTo)
        {
